...
static int encode_int(B256_56::BIG x, char *ei)
{
    int b, index = 0;

    if (8 * MODBYTES_B256_56 == MBITS_F25519)
...
// encode point
static void encode(Ed25519::ECP *P, octet *W)
{
    BIG x, y;
    int b, index = 0;
...
static int decode_int(bool strip_sign, char *ei, B256_56::BIG x)
{
    int b, index = 0;
    int sign = 0;
    char r[MODBYTES_B256_56 + 1];
...
static void decode(octet *W, Ed25519::ECP *P)
{
    BIG X, Y;
    FP x, d, t, one, hint;
...
bool Ed25519::EDDSA_VERIFY(bool ph, octet *Q, octet *context, octet *M, octet *SIG)
{
    DBIG du;
    BIG q, t, su;
    ECP R, QD, G;
